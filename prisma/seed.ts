...
async function main() {
 ...
 const student=await prisma.user.upsert({where:{email:'aluno@faeterj-petropolis.edu.br'},update:{},create:{email:'aluno@faeterj-petropolis.edu.br',passwordHash,roles:{create:{enrollment:'2023100101',name:'',email:'aluno@faeterj-petropolis.edu.br',phone:''}}}});
