...
async function main() {
 ...
 const student=await prisma.user.upsert({where:{email:'aluno@faeterj-petropolis.edu.br'},update:{},create:{email:'aluno@faeterj-petropolis.edu.br',passwordHash,roles:{create:{roleId:studentRole.id}},student:{create:{enrollment:'2023100101',name:'Aluno de Teste',email:'aluno@faeterj-petropolis.edu.br',phone:'24999999999'}}}});
